#prehardmode
	...
	#creepers
		execute unless score Target Hardmode matches 1 as @e[type=minecraft:creeper,tag=!buffed] at @s run summon minecraft:creeper ^ ^ ^0.5 {Tags:["buffed"]}
...
#hardmode
	...
	#creepers
		execute if score Target Hardmode matches 1 as @e[type=minecraft:creeper,tag=!buffed] at @s run data merge entity @s {powered:1b}
		execute if score Target Hardmode matches 1 as @e[type=minecraft:creeper,tag=!buffed] at @s run summon minecraft:creeper ^ ^ ^0.5 {Tags:["buffed"],powered:1b}
		execute if score Target Hardmode matches 1 as @e[type=minecraft:creeper,tag=!buffed] at @s run summon minecraft:creeper ^ ^ ^-0.5 {Tags:["buffed"],powered:1b}
